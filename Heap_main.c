...
// 0 tabanlý indexlemede array içindeki i. düðümün childlarýnýn ve parentýnýn hesaplanmasý için makrolar
...
// Parametre olarak verilen kapasitede bir HeapArray yapýsý oluþturur.
...
// Parametre olarak verilen indexteki max-heap özelliðini bozan indexteki elemaný left ve right childlarýndan büyük olanýyla deðiþtirir
// ve deðiþtirilen elemandan yine ayný prosedürü recursive olarak tekrarlar.
...
// Heapdeki en büyük deðeri (root) silmeden döndürür.
...
// Heapdeki eleman sayýsýný döndürür.
...
// Heap dolu mu boþ mu kontrol eder.
...
// Heapdeki en büyük deðeri (root) döndürür
// ve root yerine sondaki elemaný yazarak silip max-heap özelliðini saðlamak root için maxHeapify fonksiyonunu çaðýrýr.
...
// Parametre olarak verilen deðeri heapin en sonuna ekler
// Sondaki eleman parentý ile max-heap özelliði saðlamýyorsa swap edip parenttan recursive olarak kontrole devam eder.
// Ekleme baþarýlý ise 1 deðil ise 0 döndürür.
